...
final Map<String, String> intlEnUs = {
  ...
  'Strangers::Description': '* Here shows strangers who want to make friends with you;\n'
      '* You can add them to your contacts, or just ignore them.',

  'GroupList::Description': '* Here shows chat histories of all your groups.',

  'BlockList::Description': '* Here shows spammers who you blocked;\n'
