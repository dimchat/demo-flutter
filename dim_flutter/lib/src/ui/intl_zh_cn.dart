...
final Map<String, String> intlZhCn = {
  ...
  'Video message forwarded to @chat': '视频消息已转发给"@chat"。',
  'Failed to share video with @chat': '无法与"@chat"分享视频。',
  ...
  'Service @title forwarded to @chat': '服务“@title”已转发到“@chat”。',
  'Failed to share Service @title with @chat': '无法与“@chat”共享服务“@title”。',
  ...
  'Cannot block this contact': '无法屏蔽此联系人。',
  ...
  'Strangers::Description': '* 这里展示了想和你交朋友的陌生人；\n'
      '* 你可以将它们添加到你的联系人中，也可以忽略它们。',

  'GroupList::Description': '* 这里显示您所有群组的聊天记录。',

  'BlockList::Description': '* 这里显示你屏蔽的用户；\n'
      '* 您将永远不会收到来自此列表的消息。',

  'MuteList::Description': '* 这里展示了那些你不太重视的吵闹的朋友；\n'
      '* 您仍然可以与他们聊天，但不会收到来自此列表的通知。',
